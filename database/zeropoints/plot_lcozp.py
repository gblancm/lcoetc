# Read ZP files in LCOETC format and display zero points againg wavelenght. 
# It works as a diagnostic tool to inspec the output generated by the zp2lco.py script
import sys
